...
5. Stop after implementation and verification. The autopilot runner will run final verification, move the step from `queue` to `history`, commit, push, and reconcile the future queue.

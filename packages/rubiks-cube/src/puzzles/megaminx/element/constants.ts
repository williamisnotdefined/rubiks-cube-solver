export const notInitialisedMessage =
  'MegaminxPuzzleElement is not initialised - element must be connected to the DOM before calling this method.';
export const renderEventName = 'megaminx-render';
...
export const InternalEvents = Object.freeze({
  cameraFieldOfViewChanged: 'megaminxCameraFieldOfViewChanged',
  cameraRadiusChanged: 'megaminxCameraRadiusChanged',
  cameraSettingsChanged: 'megaminxCameraSettingsChanged',
});

export const MegaminxAttributeNames = {

...
export function ScanFaceCaptureStep({
  ...
  return (
    <fieldset className='contents' disabled={interactionDisabled}>
      <ScanFaceCarousel
      ...
      >
        <div className='grid gap-4 lg:grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.8fr)]'>
          ...
          <div className='grid content-start gap-4'>
            ...
            <p
              className='min-h-10 text-sm font-semibold leading-relaxed text-app-muted'
              aria-live='polite'
            >
            ...
            <Tooltip content={finalActionDisabledReason}>
              <span
                ...
                tabIndex={finalActionDisabledReason === undefined ? undefined : 0}
              >
                <Button

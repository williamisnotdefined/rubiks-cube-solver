...
describe('Algorithms pages', () => {
  ...
  it('renders an OLL algorithm sheet with local case images', async () => {
    ...
    expect(screen.getByRole('img', { name: '3x3 OLL 29' })).toHaveAttribute(
      'src',
      '/algorithms/3x3/oll/oll-29.png',
    )
  ...
  it('renders another imported algorithm sheet', async () => {
    ...
    expect(screen.getByRole('link', { name: 'JPerm 4x4 PLL' })).toHaveAttribute(
      'href',
      'https://jperm.net/algs/4x4/pll',
    )
  })
  ...
  it('renders a SpeedCubeDB algorithm sheet with local case images', async () => {
    ...
    expect(screen.getByRole('link', { name: 'SpeedCubeDB F2L' })).toHaveAttribute(
      'href',
      'https://speedcubedb.com/a/3x3/F2L',
    )
    expect(screen.getByRole('img', { name: '3x3 F2L F2L 1' })).toHaveAttribute(
      'src',
      '/algorithms/3x3/f2l/f2l-f2l-1.svg',
    )

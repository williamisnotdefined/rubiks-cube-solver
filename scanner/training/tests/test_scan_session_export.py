...
from scanner.contracts.scan_session_export import load_scan_session_export_file, validate_scan_session_export


def test_loads_sample_scan_session_export_fixture() -> None:
    export = load_scan_session_export_file(Path("scanner/training/fixtures/sample_scan_session_export.json"))

---
applyTo: "apps/web/src/components/Field/**/*.{ts,tsx},apps/web/src/components/FormControls/**/*.{ts,tsx},apps/web/src/pages/SolvePage/solve/SolveForm/**/*.{ts,tsx},apps/web/src/pages/SolvePage/scan/ScanColorPalette/**/*.{ts,tsx}"
---

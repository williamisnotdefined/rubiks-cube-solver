...
description: "Use when adding, changing, extracting, or reusing React components, Storybook stories, page-level screens, large frontend files, or repeated UI in web."
---

...
export function TimerRuntime({ disabled, resetSignal, onSolveComplete }: TimerRuntimeProps) {
  ...
  const updateLatestSolvePenalty = useTimerStore((state) => state.updateLatestSolvePenalty)
